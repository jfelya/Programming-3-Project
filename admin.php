...
<body>
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-sm-3">
				<a class="btn btn-outline-primary btn-block" role="button" .disabled href="admin-usuario.php">Registrar Usuario</a>
			</div>
			<div class="col-sm-3">
				<a class="btn btn-outline-primary btn-block" role="button" .disabled href="admin-producto.php">Registrar Producto</a><br>
			</div>
			<div class="col-sm-3"></div>
		</div>
		<div class="row">
