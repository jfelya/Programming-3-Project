...
if (isset($_REQUEST["compra"]) && isset($_SESSION["carrito"]) && isset($_SESSION["preciototal"])) {
	...
	foreach ($carrito as $posicion => $posicionvalor) {
		...
		$sql4 = "INSERT INTO `factura` (`id_factura`, `id_cliente`, `fecha`, `preciototal`) VALUES ('$id_factura', '$id_cliente', '$fecha', '$preciototal')";
		...
		$sql2 = "UPDATE producto SET stock = '$nuevostock' WHERE id_producto = '$id_producto'";
		...
		$sql3 = "INSERT INTO `detalle` (`id_factura`,`id_producto`,`cantidad`, `precio`) VALUES ('$id_factura','$id_producto','$cantidadProducto', '$precio')";
