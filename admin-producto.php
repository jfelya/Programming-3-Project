		...
		<div class="container-fluid">
			...
			<form name="registro_producto" action="procesos/producto_proceso.php" method="POST" onsubmit="return validacion_registro_producto()">
				...
				<div class="row">
					...
					<div class="col-sm-4">
						<a class="btn btn-outline-secondary btn-block" role="button" .disabled href="lista_de_productos.php">Lista de Productos</a>
					</div>
	...
	//SI SE ELIGE LA FUNCIÓN DE MODIFICAR PRODUCTOS
		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-sm-1">
					<a class="btn btn-outline-secondary" href="lista_de_productos.php"><</a>
				</div>
			</div><br><br>
